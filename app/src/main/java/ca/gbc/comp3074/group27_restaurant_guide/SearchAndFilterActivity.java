...
public class SearchAndFilterActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new RestaurantAdapter(this, R.layout.restaurant_row, restaurants);
...
class RestaurantAdapter extends ArrayAdapter<Restaurant> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.restaurant_row, parent, false);
